...
<ul class="filariane ms-2">
	...
	<li><a href="?page=vente">Liste des ventes</a></li>
...
<main class="container">
	...
	<div class="row">
		<div class="col-sm-3">
			<ul class="list-group mt-2">
				<li class="col-sm-12 list-group-item d-flex justify-content-between align-items-center">
					<p class="my-2">Nombre de jeux</p>
					<span class="badge bg-secondary rounded-pill" id='NbJeuxVendus'></span>
				</li>
				<li class="col-sm-12 list-group-item d-flex justify-content-between align-items-center">
					<p class="my-2">Montant total</p>
					<span class="badge bg-secondary rounded-pill" id='TotalJeuxVendus' data-total=""></span>
				</li>
			</ul>
		</div>
		<div class="col-sm-9">
			<form id="choixreglement" target="_blank">
				<input type="hidden" id="ip" value="<?php echo htmlspecialchars($_SERVER['REMOTE_ADDR']); ?>" />
				<div class="row">
					<div class="col-md-4">
						...
						<div class="form-floating mb-3">
							<input type="text" class="form-control" id="MontantDon" placeholder=" "> 
							<label for="MontantDon">Montant du don</label>
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-floating mb-3">
							<input type="text" class="form-control" id="MontantPercu" placeholder=" "> 
							<label for="MontantPercu">Montant perçu</label>
						</div>
						<div class="form-floating mb-3">
							<input type="text" class="form-control" id="MontantRendu" placeholder=" " readonly> 
							<label for="MontantRendu">Montant à rendre</label>
						</div>
					</div>
					<div class="col-md-4">
						<div class="row">
							<div class="col-md-12 mb-3">
								<button id="showModal" type="button" class="btn btn-warning">Ajouter un acheteur</button>
							</div>
						</div>
						<div class="row">
							<div class="col-md-12">
								<button id="finaliserbutton" type="button" class="btn btn-success">Finaliser la vente</button>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="col-sm-6">
			<div class="card">
				...
				<div class="card-body">
					...
					<p>Passer un jeu du stock à vendu : double cliquer sur la ligne</p>
				</div>
			</div>
		</div>
		<div class="col-sm-6">
			<div class="card">
				...
				<div class="card-body">
					...
					<p>Ne plus vendre un jeu : cliquer sur l'icone <i class="bi bi-cart-x" style="font-size: 1em; color: black;"></i> dans la colonne action</p>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="alert alert-danger mt-3" role="alert">
		...
		Sinon, rendez-vous sur <a href="?page=listejeux" target="_blank">cette page</a>, recherchez les jeux avec le statut <em>« en panier »</em>, et remettez-les en <em>« en stock »</em> pour qu’ils réapparaissent dans la liste des jeux disponibles.
	</div>

</main>

<?php
// On inclut la modale acheteur depuis les vues partielles
require __DIR__ . '/partials/modaleacheteur.php';
?>