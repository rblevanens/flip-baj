    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header justify-content-center">
                <h2 id="modal-titre" class="text-center modal-title">Création d'un vendeur</h2>
            </div>
            <form id="formulaire" class="form-horizontal" autocomplete="off">
                <div id="modal-body" class="modal-body">
                    ...
                    <div class="mb-3 row">
                        <div class="col-sm-6">
                            <div class="form-floating">
                                <input id="nomVendeurACreer" type="text" class="form-control" placeholder=" " aria-required="true">
                        ...
                        <div class="col-sm-6">
                            <div class="form-floating">
                                <input id="prenomVendeurACreer" type="text" class="form-control" placeholder=" " aria-required="true">
                    ...
                    <div class="mb-3 row">
                        <div class="col-sm-8">
                            <div class="form-floating">
                                <input type="email" class="form-control" id="emailVendeurACreer" placeholder=" " aria-required="true">
                        ...
                        <div class="col-sm-4">
                            <div class="form-floating">
                                ...
                                <small class="form-text text-muted">Format : 06 12 34 56 78</small>
                                <label for="telephoneVendeurACreer">Téléphone</label>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <div class="text-center mt-3">Adresse de facturation</div>
                        </div>
                        <div class="mb-3 row">
                            <div class="col-sm-12">
                                <div class="form-floating">
                                    <input id="adresseVendeurACreer" type="text" class="form-control" placeholder=" " aria-required="true">
                        ...
                        <div class="mb-3 row">
                            <div class="col-sm-6">
                                <div class="form-floating">
                                    <input id="codepostalVendeurACreer" type="text" class="form-control" placeholder=" " aria-required="true">
                            ...
                            <div class="col-sm-6">
                                <div class="form-floating">
                                    <input id="villeVendeurACreer" type="text" class="form-control" placeholder=" " aria-required="true">
                        ...
                        <div class="mb-3 row">
                            <div class="text-center mt-3">Statut</div>
                        </div>
                        <div class="mb-3 row">
                            <div class="col-sm-3"></div>
                            <div class="col-sm-6">
                                <select name="Liste_statut" id="Liste_statut" class="form-select" aria-required="true">
                        ...
                        <div class="mb-3 row champ justify-content-center" id="champ1" style="display:none;">
                            <div class="col-sm-3"></div>
                            <div class="col-sm-4 mt-2">Attestation signée</div>
                            <div class="col-sm-2">
                                <select name="attestation_signeeVendeurACreer" id="attestation_signeeVendeurACreer" class="form-select" aria-required="true">
                                    <option id="0" value="0">Non</option>
                                    <option id="1" value="1">Oui</option>
                                </select>
                            </div>
                            <div class="col-sm-3"></div>
                            <div class="col-sm-5"><div class="invalid-feedback" id="attestation-result"></div></div>
                        </div>
                        <div class="champ mb-3 row" id="champ2" style="display:none;">
                            <div class="col-sm-6">
                                <div class="form-floating">
                                    <input id="denomination_socialeVendeurACreer" type="text" class="form-control" placeholder=" " aria-required="true">
                            ...
                            <div class="col-sm-6">
                                <div class="form-floating">
                                    <input id="siege_socialVendeurACreer" type="text" class="form-control" placeholder=" " aria-required="true">
                    ...
                    <div id="modal-footer" class="modal-footer">
                        <div class="mb-2 row">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="forcesave">Enregistrer le vendeur malgré un homonyme dans la base</label>
                            </div>
                        </div>
                        <button id="boutoncancel" type="button" class="btn btn-secondary">Annuler</button>
                        <button id="boutonsavevendeur" type="button" class="btn btn-success">Enregistrer</button>
                    </div>
            </form>
        </div>
    </div>
