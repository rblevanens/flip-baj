        ...
        <div class="col">
            <div class="card text-center">
                ...
                <div class="card-body">
                    ...
                    <a href="?page=selectionvendeur&t=reception" class="btn btn-primary">Allez-y</a>
                </div>
            </div>
        </div>
        ...
        <div class="col">
            <div class="card text-center">
                ...
                <div class="card-body">
                    ...
                    <a href="?page=vente" class="btn btn-primary">Allez-y</a>
                </div>
            </div>
        </div>
        ...
        <div class="col">
            <div class="card text-center">
                ...
                <div class="card-body">
                    ...
                    <a href="?page=selectionvendeur&t=restitution" class="btn btn-primary">Allez-y</a>
                </div>
            </div>
        </div>
        ...
        <div class="col">
            <div class="card text-center">
                ...
                <div class="card-body">
                    ...
                    <a href="?page=listejeux" class="btn btn-primary">Allez-y</a>
                </div>
            </div>
        </div>
        ...
        <div class="col">
            <div class="card text-center">
                ...
                <div class="card-body">
                    ...
                    <a href="?page=stats" class="btn btn-primary">Allez-y</a>
                </div>
            </div>
        </div>
        ...
        <div class="col">
            <div class="card text-center">
                ...
                <div class="card-body">
                    ...
                    <a href="?page=admin" class="btn btn-primary">Allez-y</a>
                </div>
            </div>
        </div>
    </div>
