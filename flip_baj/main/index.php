...
<main>
	<div class="container">
		<h2 class="text-center my-4">Bienvenue à la bourse aux Jeux !</h2>
		<div class="row">
			<div class="col">
				<div class="card text-center">
					...
					<div class="card-body">
						...
						<a href="selectionvendeur.php?t=reception" class="btn btn-primary">Allez-y</a> <!-- 'Réception' ou 'Allez-y' -->
					</div>
				</div>
			</div>
			<div class="col">
				<div class="card text-center">
					...
					<div class="card-body">
						...
						<a href="vente.php" class="btn btn-primary">Allez-y</a> <!-- 'Vente' ou 'Allez-y' -->
					</div>
				</div>
			</div>
			<div class="col">
				<div class="card text-center">
					...
					<div class="card-body">
						...
						<a href="selectionvendeur.php?t=restitution" class="btn btn-primary">Allez-y</a> <!-- 'Restitution' ou 'Allez-y' -->
					</div>
				</div>
			</div>
			<div class="col">
				<div class="card text-center">
					...
					<div class="card-body">
						...
						<a href="listejeux.php" class="btn btn-primary">Allez-y</a> <!-- 'Rechercher' ou 'Allez-y' -->
					</div>
				</div>
			</div>
			<div class="col">
				<div class="card text-center">
					...
					<div class="card-body">
						...
						<a href="stats.php" class="btn btn-primary">Allez-y</a> <!-- 'Statistiques' ou 'Allez-y' -->
					</div>
				</div>
			</div>
			<div class="col">
				<div class="card text-center">
					...
					<div class="card-body">
						...
						<a href="admin.php" class="btn btn-primary">Allez-y</a> <!-- 'Admin' ou 'Allez-y' -->
					</div>
				</div>
			</div>
		</div>
