...
include ('header.php');
/**
 * Contenu de la fenêtre modale "créer/modifier acheteur
 *
 * le <form> est à autocomplete = "off" côté festival pour éviter qu'un nouveau acheteur en écrase un ancien/récupère des données d'un ancien
 */
?>
